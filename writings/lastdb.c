...
double confidence = op == 9 ? ess_conf * decay_conf : ess_conf;
                                ...
                                if (ess < 30.0 * (double)(1 + max_wl) || confidence < 0.15) { count_est = 0; sum = 0; }
...
double conf = ess >= 1000 ? 1.0 : ess / 1000.0;
                ...
                if (ess < 30.0 * (double)(1 + max_wl) || conf < 0.15) count_est = 0;
...
if (threshold > 1.0) threshold = 1.0;
            ...
            if (r->v_len > 0) {
                ...
                if ((double)raw_s < 30.0 * (1 + max_wl) || conf < 0.15) s = 0;
